...
function main() {
  ...
  if (names.length === 0) {
    ...
    console.log("acp-v2/src/resources.ts and wire matching handlers in BasicBot.Api/Program.cs.");
    return;
  }
  ...
  console.log(`Paste each block into app.virtuals.io → BasicBot agent → Resources → New resource.`);
